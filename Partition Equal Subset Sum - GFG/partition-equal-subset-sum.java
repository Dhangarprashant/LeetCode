...
//         return function(0,targetsum,arr,memo)?1:0;
//     }
//     static boolean function (int pos,int sum,int arr[]){
//         if(sum<0){
//             return false;
//         }
//         if(pos==arr.length){
...
//             return true;
//         }
//         return memo[pos][sum]=function(pos+1,sum,arr,memo) || function(pos+1,sum-arr[pos],arr,memo);
//     }
// }
